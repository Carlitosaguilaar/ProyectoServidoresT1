    ...
    <div class="contenedor_form">
        ...
        <form method="GET" action="insertar_servicio.php" class="formulario">
            ...
            <div class="campo">
                ...
                <input type="text" id="precio_servicio" name="precio_servicio"  placeholder="Precio" class="inputs" required>
            </div>

            <div class="campo">
                <label for="descripcion">Descripción: </label>
                <input type="text" id="descripcion" name="descripcion"  placeholder="Descripción" class="inputs" required>
            </div>

            <div class="campo">
                <label for="fecha_servicio">Fecha: </label>
                <input type="date" id="fecha" name="fecha"  placeholder="Fecha" class="inputs" required>
            </div>
